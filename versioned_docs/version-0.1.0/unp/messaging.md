...
> A only needs to create a payment if he's served on a pay-per-use plan by SA. If A has a `fixed-monthly-fee service plan` with SA or if it is in a free-trial plan, then this step is skipped.
